...
/**
 * Criteria class for the {@link sn.sonatel.dsi.ins.imoc.domain.Notification} entity. This class is used
 * in {@link sn.sonatel.dsi.ins.imoc.web.rest.NotificationResource} to receive all the possible filtering options from
...
public class NotificationCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, reservationId, userLogin, deleted, read, distinct);
    }
